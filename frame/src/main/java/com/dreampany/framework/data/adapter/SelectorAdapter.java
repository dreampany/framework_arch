...
public class SelectorAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    private Context mContext;
    private ArrayList<String> mBackupStrings;
    private ArrayList<String> mStrings;
    private StringFilter mStringFilter = new StringFilter();

    public SelectorAdapter(Context context, ArrayList<String> strings) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            view = View.inflate(mContext, R.layout.item_selector, null);
    ...
    public View getNoSelectionView() {
        View view = View.inflate(mContext, R.layout.item_no_selector, null);
        return view;
    }
