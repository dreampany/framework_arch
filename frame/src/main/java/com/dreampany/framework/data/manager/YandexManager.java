...
public class YandexManager {
    ...
    private static final String TRANSLATE_KEY = "trnsl.1.1.20161030T180756Z.60da70e5588593ed.07aab6b85bc782a80495fea9ceb00c1cf06e7310";
...
/*    public String getTranslation(String target, String text) {
        Translation translation = translateApi.translationApi().translate(text, Language.of(target));
        return translation.text();
    }*/

    public String getTranslation(String target, String text) {

        String url = TRANSLATE_HOST + "key=" + TRANSLATE_KEY + "&text=" + text + "&lang=en-" + target;
        ...
        try {
            ...
            JsonArray array = json.getAsJsonArray("text");
            return array.get(0).getAsString();

        } catch (IOException e) {
            LogKit.verbose("Translation Exception: " + e.toString());
        }
